...
HD_PWD='/nfs/ug/homes-0/y/yusufal5/Desktop/ChorusFilterTester/project_1/project_1.runs/design_1_ChorusFilter_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_ChorusFilter_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_ChorusFilter_0_3.tcl
