...
proc create_root_design { parentCell } {
  ...
  set bluetooth [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 bluetooth ]
...
CONFIG.PHASE {0.000} \
  ...
  # Create instance: Chorus_0, and set properties
  set Chorus_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Chorus:1.0 Chorus_0 ]

  # Create instance: PWMGenerator_0, and set properties
  set PWMGenerator_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:PWMGenerator:1.0 PWMGenerator_0 ]
...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  set bluetooth_uart [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_uartlite:2.0 bluetooth_uart ]
  set_property -dict [ list \
...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  connect_bd_intf_net -intf_net axi_uartlite_1_UART [get_bd_intf_ports bluetooth] [get_bd_intf_pins bluetooth_uart/UART]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins bluetooth_uart/S_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_1_M0_AXIS [get_bd_intf_pins Chorus_0/S00_AXIS] [get_bd_intf_pins microblaze_1/M0_AXIS]
  ...
  # Create port connections
  connect_bd_net -net Chorus_0_dataOut [get_bd_pins Chorus_0/dataOut] [get_bd_pins PWMGenerator_0/PCM]
  connect_bd_net -net PWMGenerator_0_AUD_SD [get_bd_ports AUD_SD] [get_bd_pins PWMGenerator_0/AUD_SD]
  connect_bd_net -net PWMGenerator_0_PWM [get_bd_ports PWM] [get_bd_pins PWMGenerator_0/PWM]
  ...
  connect_bd_net -net bluetooth_uart_interrupt [get_bd_pins bluetooth_uart/interrupt] [get_bd_pins microblaze_0_xlconcat/In2]
  ...
  connect_bd_net -net microblaze_1_Clk [get_bd_pins Chorus_0/s00_axis_aclk] [get_bd_pins PWMGenerator_0/clk] [get_bd_pins axi_ethernetlite_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins bluetooth_uart/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/S01_ACLK] [get_bd_pins microblaze_0_axi_periph/S02_ACLK] [get_bd_pins microblaze_0_axi_periph/S03_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins microblaze_1/Clk] [get_bd_pins microblaze_1_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins Chorus_0/s00_axis_aresetn] [get_bd_pins axi_ethernetlite_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins bluetooth_uart/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S01_ARESETN] [get_bd_pins microblaze_0_axi_periph/S02_ARESETN] [get_bd_pins microblaze_0_axi_periph/S03_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40610000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs bluetooth_uart/S_AXI/Reg] SEG_axi_uartlite_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40610000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs bluetooth_uart/S_AXI/Reg] SEG_axi_uartlite_1_Reg
  ...
  create_bd_addr_seg -range 0x00004000 -offset 0x00000000 [get_bd_addr_spaces microblaze_1/Data] [get_bd_addr_segs microblaze_1_local_memory/dlmb_bram_if_cntlr/SLMB/Mem] SEG_dlmb_bram_if_cntlr_Mem
  create_bd_addr_seg -range 0x00004000 -offset 0x00000000 [get_bd_addr_spaces microblaze_1/Instruction] [get_bd_addr_segs microblaze_1_local_memory/ilmb_bram_if_cntlr/SLMB/Mem] SEG_ilmb_bram_if_cntlr_Mem
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40E00000 [get_bd_addr_spaces microblaze_1/Data] [get_bd_addr_segs axi_ethernetlite_0/S_AXI/Reg] SEG_axi_ethernetlite_0_Reg
  exclude_bd_addr_seg [get_bd_addr_segs microblaze_1/Data/SEG_axi_ethernetlite_0_Reg]

  create_bd_addr_seg -range 0x00010000 -offset 0x41C00000 [get_bd_addr_spaces microblaze_1/Data] [get_bd_addr_segs axi_timer_0/S_AXI/Reg] SEG_axi_timer_0_Reg
  exclude_bd_addr_seg [get_bd_addr_segs microblaze_1/Data/SEG_axi_timer_0_Reg]
  ...
  exclude_bd_addr_seg [get_bd_addr_segs microblaze_1/Data/SEG_axi_uartlite_0_Reg]

  create_bd_addr_seg -range 0x00010000 -offset 0x40610000 [get_bd_addr_spaces microblaze_1/Data] [get_bd_addr_segs bluetooth_uart/S_AXI/Reg] SEG_bluetooth_uart_Reg
  exclude_bd_addr_seg [get_bd_addr_segs microblaze_1/Data/SEG_bluetooth_uart_Reg]
  ...
  exclude_bd_addr_seg [get_bd_addr_segs microblaze_1/Data/SEG_microblaze_0_axi_intc_Reg]
